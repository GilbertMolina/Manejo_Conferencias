...
<div class="menu">
	<ul>
		...
		<li><a href="mostrarOrdenesDePago.php" target="_self" >Ordenes de Pago</a>
			<ul>
				<li><a href="mostrarOrdenesDePago.php" target="_self">Mostrar</a></li>
				<li><a href="descargarOrdenesDePago.php" target="_self">Imprimir</a></li>
			</ul>
		</li>
		...
		<li><a href="../itinerarioConferencista/mostrarItinerario.php" target="_self" >Itinerario</a></li>
		<?php
